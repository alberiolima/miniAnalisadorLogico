...
**
**   Nokia LCD    ATmega8  Adruino  LCD(vermelho)
**  ------------  -------  -------  ----
**  LCD_CLK_PIN     PB4      D12    SCLK
**  LCD_DATA_PIN    PB3      D11    DNK
**  LCD_DC_PIN      PB2      D10    D/C
**  LCD_RST_PIN     PB1      D09    RST
**  LCD_CE_PIN      PB0      D08    SCE
**  
**   - History -
**
...
#define BTN_INCREASE   PD4 //D04
#define BTN_DECREASE   PC5 //A5
#define BTN_ZOOM_OUT   PD5 //D05
#define LED1           PB5 //D13
